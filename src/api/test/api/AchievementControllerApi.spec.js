...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.AchievementControllerApi();
  });
  ...
  describe('AchievementControllerApi', function() {
    ...
    describe('getAllByPersonId', function() {
      it('should call getAllByPersonId successfully', function(done) {
        //uncomment below and update the code to test getAllByPersonId
        //instance.getAllByPersonId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
